...
describe("search validation", () => {
  it("enforces the 1K–100K product range", () => expect(searchSchema.safeParse({ niche: "Tech", platforms: ["YouTube"], minFollowers: 999, maxFollowers: 100000, limit: 8 }).success).toBe(false));
